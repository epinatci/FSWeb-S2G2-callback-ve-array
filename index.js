...
// const finalIceren = fifaData.filter(finalli => {return finalli.Stage === 'Final' && finalli.Year === 2014 });
...
function Finaller(data) {
	const finalData = data.filter(Finaller => {return Finaller.Stage === 'Final'});
	return  finalData
}
